...
convert -size 500x500 xc:none -fill 'red' -pointsize 60 -font 'Fonts/fzlt2.ttf' -gravity center -draw 'text 0,-10 "运动户外"' -font 'Fonts/fzlt.ttf' -pointsize 40  -draw 'text 0,50 "立即查看"'  RegularThin.png